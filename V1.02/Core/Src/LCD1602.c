/*
 * lcd1602.c based on lcd control from Controllerstech https://controllerstech.com/interface-lcd-16x2-with-stm32-without-i2c/
 *
 *
...
#define timer htim2 // Here is defined used timer
